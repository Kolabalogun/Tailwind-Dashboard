...
const Main = ({ windowSize }) => {
  ...
  return (
    <div
      className={`flex flex-col pt-4 pb-6 px-1  xsm:px-3 sm:px-6 ${
        mode ? "bg-white" : "bg-[#1c1c1c] "
      } min-h-[92vh]`}
    >
      <div className="py-6 px-3 xsm:px-6 ">
        <p className={`pr-3 ${mode ? "text-black " : "text-white"}`}>
          All Events
        </p>
        ...
        <div className="lg:flex lg:flex-row flex-col items-center justify-center flex gap-5 ">
          <div className=" bg-[#282828]  mb-6 lg:mb-0 md:w-[380px] w-[280px]  p-4 relative boxinit ">
            ...
            <div className="mt-[50px]">
              <p
                className={`${mode ? "text-black " : "text-white"} text-[14px]`}
              >
                Versastyle: Toronto
              </p>
              <p
